...
class FileReader:
    def __init__(self):
        ...
        self.input_path = di.INPUT_FOLDER
    ...
    def read_csv_file(self, file):
        return pd.read_csv(file, header=di.HEADER_LINE)
    ...
    def get_tile_type(self, data):
        return data[di.TILE_TYPE_COLUMN].values.tolist()
    ...
    def load_model(self, path, filename):
        model_filename = path + di.MODEL_FOLDER + filename + ".json"
        weights_filename = path + di.MODEL_FOLDER + filename + ".h5"
