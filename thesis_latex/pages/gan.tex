...
\end{tabular}
\end{center}
\captionof{table}{Μετρήσεις σφάλματος και ακρίβειας για το μοντέλο του Discriminator. Η ακρίβεια μετριέται στην κλίμακα 0-1.} \label{tab:title}
...
\end{tabular}
\end{center}
\captionof{table}{Μετρήσεις σφάλματος και ακρίβειας για το μοντέλο του GAN. Το μοντέλο GAN περιλαμβάνει την συνδυαστική εκτέλεση των δικτύων του Generator και Discriminator. Η ακρίβεια μετριέται στην κλίμακα 0-1.} \label{tab:title}
