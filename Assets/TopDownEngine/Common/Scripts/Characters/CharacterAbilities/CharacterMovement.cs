...
{	
	...
	public class CharacterMovement : CharacterAbility 
	{
		...
		{
			MMAnimator.UpdateAnimatorFloat(_animator,"Speed",Mathf.Abs(_controller.CurrentMovement.magnitude),_character._animatorParameters);
			...
			MMAnimator.UpdateAnimatorBool(_animator,"Idle",(_movement.CurrentState == CharacterStates.MovementStates.Idle),_character._animatorParameters);
		}
	}
}