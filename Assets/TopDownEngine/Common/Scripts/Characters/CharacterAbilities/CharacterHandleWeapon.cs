...
namespace MoreMountains.TopDownEngine
{
    ...
    public class CharacterHandleWeapon : CharacterAbility
    {
        ...
        protected override void InitializeAnimatorParameters()
        {
            ...
            RegisterAnimatorParameter("WeaponEquipped", AnimatorControllerParameterType.Bool);
            RegisterAnimatorParameter("WeaponEquippedID", AnimatorControllerParameterType.Int);
        ...
        {
            MMAnimator.UpdateAnimatorBool(_animator, "WeaponEquipped", (CurrentWeapon != null), _character._animatorParameters);
            if (CurrentWeapon == null)
            {
                MMAnimator.UpdateAnimatorInteger(_animator, "WeaponEquippedID", -1, _character._animatorParameters);
                return;
            }

            MMAnimator.UpdateAnimatorInteger(_animator, "WeaponEquippedID", CurrentWeapon.WeaponAnimationID, _character._animatorParameters);
            ...
            if (_weaponAim != null)
            {
                MMAnimator.UpdateAnimatorFloat(_animator, CurrentWeapon.WeaponAngleAnimationParameter, _weaponAim.CurrentAngle, _character._animatorParameters);
                MMAnimator.UpdateAnimatorFloat(_animator, CurrentWeapon.WeaponAngleRelativeAnimationParameter, _weaponAim.CurrentAngleRelative, _character._animatorParameters);
            }
            else
            {
