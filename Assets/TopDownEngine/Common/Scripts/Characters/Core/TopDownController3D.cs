...
namespace MoreMountains.TopDownEngine
{
    ...
    public class TopDownController3D : TopDownController
    {
        ...
        protected virtual void OnTriggerEnter(Collider other)
        {
            ...
            if (other.gameObject.GetComponentNoAlloc<MovingPlatform3D>() != null)
            {
                if (this.transform.position.y < other.transform.position.y)
                {
                    ...
                    this.Impact(_pushbackDirection.normalized, other.gameObject.GetComponentNoAlloc<MovingPlatform3D>().PushForce);
                }
            }
        }
        ...
        public override bool CanGoBackToOriginalSize()
        {
            ...
            bool headCheck = MMDebug.RayCast(_originalSizeRaycastOrigin, transform.up, headCheckDistance, GroundLayerMask, Color.cyan, true);
