...
namespace MoreMountains.TopDownEngine
{
    public class WelcomeWindow : EditorWindow
    {
        ...
        public const string DEFINE_POSTPROCESSING_INSTALLED = "POSTPROCESSING_INSTALLED";
        public const string DEFINE_CINEMACHINE_INSTALLED = "CINEMACHINE_INSTALLED";
        public const string DEFINE_PIXELPERFECT_INSTALLED = "PIXELPERFECT_INSTALLED";

        public static string PostProcessingPackageID = "com.unity.postprocessing";
        public static string PostProcessingPackageVersionID = "com.unity.postprocessing@2.0.14-preview";

        public static string CinemachinePackageID = "com.unity.cinemachine";
        public static string CinemachinePackageVersionID = "com.unity.cinemachine@2.2.7";
        ...
        public static void ShowWindow()
        {
            ...
            editorWindow.Show();
            DependencyInstaller.TestDependencies();
        }
        ...
        private void OnGUI()
        {
            ...
            Texture2D welcomeImage = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/TopDownEngine/Common/Scripts/Welcome/welcome-banner.png", typeof(Texture2D));
