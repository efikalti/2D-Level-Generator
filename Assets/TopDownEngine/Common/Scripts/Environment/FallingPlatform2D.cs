...
{	
	...
	public class FallingPlatform2D : MonoBehaviour 
	{
		...
		{				
			if (_animator!=null)
            {
                MMAnimator.UpdateAnimatorBool(_animator, "Idle", (State == FallingPlatformStates.Idle));
                MMAnimator.UpdateAnimatorBool(_animator, "Shaking", (State == FallingPlatformStates.Shaking));
                MMAnimator.UpdateAnimatorBool(_animator, "Falling", (State == FallingPlatformStates.Falling));
            }
		}
