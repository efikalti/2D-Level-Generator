...
namespace MoreMountains.TopDownEngine
{
    ...
    public class SoundManager : PersistentSingleton<SoundManager>, MMEventListener<MMSfxEvent>, MMEventListener<TopDownEngineEvent>, MMEventListener<MMGameEvent>
    {
        [Header("Settings")]
        ...
        {
            PlaySound(sfxEvent.ClipToPlay, this.transform.position, sfxEvent.Pitch, 0.0f, 0.0f, sfxEvent.Volume, false, audioGroup: sfxEvent.AudioGroup);
        }
