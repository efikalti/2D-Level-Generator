...
#endif
    public class MMCinemachineZoom : MonoBehaviour, MMEventListener<MMCameraZoomEvent>
    {
        ...
        public virtual void OnMMEvent(MMCameraZoomEvent zoomEvent)
        {
            this.Zoom(zoomEvent.Mode, zoomEvent.FieldOfView, zoomEvent.TransitionDuration, zoomEvent.Duration);
        }
        ...
        {
            this.MMEventStartListening<MMCameraZoomEvent>();
        }
        ...
        {
            this.MMEventStopListening<MMCameraZoomEvent>();
        }
    }
}
