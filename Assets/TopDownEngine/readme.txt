...
If you've imported the asset in a blank project, the TopDown Engine should automatically handle that for you, and install the required dependencies.

If despite that, you still get errors mentioning Cinemachine or PostProcessing, you can try to go to the Tools Menu at the top of your screen, then More Mountains, then Welcome To The TopDown Engine. That should fix it.

If that's not the case, please check this page : https://topdown-engine-docs.moremountains.com/#i-get-errors-after-installing-the-package--the-camera-doesnt-move
